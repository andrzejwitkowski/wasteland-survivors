...
const CHECKED_FLOOR_TEXTURE_PATH: &str = "textures/pavement/checked/checkered_pavement_tiles_diff_1k.png";
const CHECKED_FLOOR_TEXTURE_NORMAL_PATH: &str = "textures/pavement/checked/checkered_pavement_tiles_nor_gl_1k.png"; // Use OpenGL normal map
const CHECKED_FLOOR_TEXTURE_ARM_PATH: &str = "textures/pavement/checked/checkered_pavement_tiles_arm_1k.png";
